...
// to see how impload works:
// echo implode(' | ', ['Jess','Jeff','Amanda']);


#4 - Not necessary.
//$file_name = explode('/', $file_path);
////$file_name = str_replace('.txt', '', end($file_name));
/* OR regex: case insensitivity (//i) + .txt at the end of the string (\.txt$) */ //$file_name = preg_replace('/\.txt$/i', '', end($file_name));
//echo $file_name;